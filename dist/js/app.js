...
$(document).ready(function () {
  ...
  // HTML imports feature detection & polyfill
  (function () {
    if ('registerElement' in document && 'import' in document.createElement('link') && 'content' in document.createElement('template')) {} else {
  ...
  var setStoreTemplate = function setStoreTemplate(link, cityName) {
  ...
  var setYelpButton = function setYelpButton(cityName) {
